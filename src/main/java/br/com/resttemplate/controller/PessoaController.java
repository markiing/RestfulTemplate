...
public class PessoaController {
	...
	@MethodDescription(description="Método responsável por recuperar Usuário")
	public @ResponseBody Pessoa teste(
			@ParamDescription(description="Nome do usuario", optional=false)
			String nome,
			@ParamDescription(description="CPF do Usuario", optional=false)
			String cpf,
			@ParamDescription(description="Idade do Usuario", optional=false)
			String idade,
			@ParamDescription(description="Objeto Pessoa", optional=false)
			Pessoa pe){
